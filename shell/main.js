...
const menuTemplate = [
  {
    ...
    submenu: [
      {
        label: 'Open File', // Modal to switch between files in proj or new?
...
function openProjectWindow() {
  if (!projectWindow) {
    projectWindow = new BrowserWindow({width: 600, height: 400, frame: false, 
      parent: mainWindow, show: false, modal: true})
  }

  projectWindow.loadURL(`file://${__dirname}/open.html`)

  projectWindow.on('closed', () => { projectWindow = null })
  projectWindow.once('ready-to-show', () => { projectWindow.show() })
  // #TODO: Send project info to React app
